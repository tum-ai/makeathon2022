        ...
        <div className={styles.Grid}>
          ...
          <div className={styles.MiddleContainer}>
            ...
            <div className={styles.Paragraph}>
              <Paragraph1
                className={styles.Paragraph}
                normalContent={data.sub_headline}
                isDarkBackground={false}
              />
            </div>
            <div className={styles.Paragraph}>
              <Paragraph1
                className={styles.Paragraph}
                highlightedContent={data.paragraph_highlighted1}
                normalContent={data.paragraph1}
                isDarkBackground={false}
              />
            </div>
            <div className={styles.Paragraph}>
              <Paragraph1
                className={styles.Paragraph}
                highlightedContent={data.paragraph_highlighted2}
                normalContent={data.paragraph2}
                isDarkBackground={false}
              />
            </div>
            <div className={styles.Paragraph}>
              <Paragraph1
                className={styles.Paragraph}
                highlightedContent={data.paragraph_highlighted3}
                normalContent={data.paragraph3}
                isDarkBackground={false}
              />
            </div>
